    ...
    <div class="field-container">
        ...
        <span class="">
            <div ref="autocomplete" class="uk-autocomplete uk-form-icon uk-form">
                ...
                <input ref="input" class="uk-form-blank" type="text" placeholder="{ App.i18n.get(opts.placeholder || 'Add Tag...') }">
            </div>
        </span>

        <span class="" each="{ _tag,idx in _tags }">
            <span class="field-tag"><i class="uk-icon-tag"></i> { _tag } <a onclick="{ parent.remove }"><i class="uk-icon-minus uk-icon-hover"></i></a></span>
        </span>
